...
// (label, ctx, layers, d_model) — the in-browser recommendation tiers.
const CONFIGS = [
  ["standard", 64, 3, 96],
  ["capable", 96, 4, 96],
];
...
for (const [label, ctx, layers, dModel] of CONFIGS) {
  const model = create(256, ctx, layers, dModel / 32, dModel, dModel * 4, 42);
